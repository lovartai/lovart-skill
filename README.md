...
| Category | Tool name | Display name |
|----------|-----------|-------------|
...
| VIDEO | `generate_video_seedance_v2_0` | Seedance 2.0 |
| VIDEO | `generate_video_seedance_v2_0_fast` | Seedance 2.0 Fast |
| VIDEO | `generate_video_seedance_pro_v1_5` | Seedance 1.5 Pro |
| VIDEO | `generate_video_kling_v3` | Kling 3.0 |
| VIDEO | `generate_video_kling_v3_omni` | Kling 3.0 Omni |
| VIDEO | `generate_video_kling_v2_6` | Kling 2.6 |
| VIDEO | `generate_video_kling_omni_v1` | Kling O1 |
| VIDEO | `generate_video_veo3_1` | Veo 3.1 |
| VIDEO | `generate_video_veo3_1_fast` | Veo 3.1 Fast |
| VIDEO | `generate_video_veo3` | Veo 3 |
| VIDEO | `generate_video_sora_v2_pro` | Sora 2 Pro |
| VIDEO | `generate_video_sora_v2` | Sora 2 |
