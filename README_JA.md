...
| 画像 | `generate_image_gpt_image` | GPT Image |  |
...
| 動画 | `generate_video_wan_v2_5` | Wan 2.5 |  |
| 動画 | `generate_video_wan_v2_6` | Wan 2.6 |  |
| 動画 | `kling_1_6` | Kling 1.6 |  |
| 動画 | `minimax_video_generator` | Hailuo-01 |  |
